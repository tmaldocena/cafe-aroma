const ReadyTo = () => {
  return (
    <div className="w-full my-32">
        <div className="xl:mx-64 mx-16 flex flex-col text-center justify-center items-center ">
            <img src="logo.svg" alt="logo" height={64} width={64} className="text-center mb-4" />
            <h2 className="xl:text-5xl text-3xl font-grotesque font-bold text-bone">Ready for a taste of <span className="text-light-brown">heaven</span>?</h2>
            <h2 className="xl:text-5xl text-3xl font-grotesque font-bold text-bone">Visit our coffee heavens today!</h2>
